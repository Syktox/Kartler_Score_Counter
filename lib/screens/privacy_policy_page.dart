        ...
        child: ListView(
          ...
          children: const [
            ...
            _PrivacySection(
              ...
              body:
                  'Kartler stores game state locally on your device with shared_preferences. This can include counter names and values, Watten game scores, Mulatschak player scores and history, and app settings such as mode and theme.',
            ),
            _PrivacySection(
              title: 'Local storage',
              body:
            ...
            _PrivacySection(
              ...
              body:
                  'Kartler does not include analytics, advertising SDKs, or third-party tracking SDKs.',
            ),
            _PrivacySection(
              title: 'Data deletion',
              body:
                  'You can delete stored game data by using the app controls where available. You can also clear all app data through your device settings or uninstall the app.',
            ),
          ],
        ),
      ),
